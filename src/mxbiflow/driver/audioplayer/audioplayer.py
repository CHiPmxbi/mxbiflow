...
from mxbiflow.driver.audioplayer.frequency_response_table import FrequencyResponseTable
from mxbiflow.driver.audioplayer.puretone_generator import PureToneUnit
...
class PlayTask:
    ...
    def complete(self, result: PlayResult) -> None:
        with self._lock:
            if self._done:
                return
            self._done = True
...
class AudioPlayer:
    ...
    def play_wav(self, file_path: Path) -> PlayTask:
        ...
        except Exception as e:  # noqa: BLE001 - report playback errors via PlayTask
            task = PlayTask()
    ...
    def play_loaded_wav(self, loaded_wav: LoadedWav) -> PlayTask:
        ...
        def worker() -> None:
            ...
            except Exception as e:  # noqa: BLE001 - report worker errors via PlayTask
                wav_end_t = perf_counter()
                total_ms = (wav_end_t - wav_start_t) * 1000
                print(
        ...
        *,
        ...
        def callback(outdata, frames, _time, status) -> None:
            ...
            try:
                ...
                raise
            except Exception as e:  # noqa: BLE001 - abort callback on backend errors
                callback_error = e
