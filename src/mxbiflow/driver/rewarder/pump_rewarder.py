...
This module provides :class:`~mxbiflow.driver.rewarder.pump_rewarder.PumpRewarder`, an
...
from mxbiflow.driver.peripheral.pumps.pump import Pump


class PumpRewarder:
    """Dispense pump-driven rewards via a :class:`~mxbiflow.driver.peripheral.pumps.pump.Pump`.
